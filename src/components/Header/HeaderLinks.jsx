  ...
  render() {
    ...
    const globe = (
      <div>
        ...
        {/* class="fa fa-ellipsis-v visible-on-sidebar-regular" */}
        <b className="caret" />
      ...
      <div>
        <Nav>
          <NavItem eventKey={1} className="custom">
            <button class="btn btn-warning btn-fill btn-round btn-icon d-none d-lg-block" style={{}}>
          ...
          <NavItem eventKey={2} style={{
            ...
            <div id="container" style={{ width: "100%" }}>
              ...
              <div id="submit_con" style={{ width: "100%", marginLeft: "30px", marginTop: "0px" }}>
                <input type="text" class="center" placeholder="Search" style={{ border: "0px" }} />
              </div>
            </div>
          </NavItem>
